...
public class Einsatzplanmodel implements Observable {
	 ...
	 *       erzeugen der benötigten Model-Hilfsklassen um diese abrufen zu
	 *       können. Außerdem wird über Datenbank_Connection die
	 *       Datenbankverbindung hergestellt, welche nur hier erzeugt wird für
	 *       das ganze Programm.
	 */
	...
	/**
	 * @author Anes Preljevic
	 * @info Fügt einen neuen Observer in die Arraylist observers hinzu, für den
	 *       Übergebenen Oberserver, benutzernamen und passwort
	 */
	...
	/**
	 * @author Anes Preljevic
	 * @info Trägt den selben oder ähnlichen Namen wie die Methode in der
	 *       Model-Hilfsklasse. Aufrufen der Methode der Model-Hilfsklasse,
	 *       sichern der Ergebnisse/Rückgabe und diese ebenfalls
	 *       zurückgeben.(Alle Methoden in dem Einsatzplanmodel sind von der
	 *       Funktion gleich, es werden nur die Rückgabewerte angepasst etc.)
	 */
	 ...
	 */
	public boolean addTag(Tag tag, String oeffnungszeit, String schließzeit, String hauptzeitbeginn,
