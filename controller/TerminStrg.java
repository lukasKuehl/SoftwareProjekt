			...
			for(TerminBlockierung tb : alleTermine){
				...
				for(Tblock_Tag tbt : alleTerminZuordnungen){
					...
					if(tbt.getTblocknr() == tb.getTblocknr()){
						...
						String temp = tb.getTblocknr() + " - " + tb.getBbez() + " - " + this.myModel.getMitarbeiter(tb.getBenutzername()).getVorname() + " " + this.myModel.getMitarbeiter(tb.getBenutzername()).getName() +" - KW" + tbt.getWpnr() + " - ";
