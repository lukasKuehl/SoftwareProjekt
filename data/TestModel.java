...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		for(Wochenplan d:wpnns){
			...
			System.out.println(d.getWpnr()+" "+ d.getÖffnungszeit() + "  " + d.getMinanzinfot()
			+ "  " + d.getMehrbesetzung()+ "  " + d.getSchließzeit()+ "  " + d.getHauptzeitbeginn()+ "  " + d.getHauptzeitende());
		...
		System.out.println(wp.getWpnr()+" "+ wp.getÖffnungszeit() + "  " + wp.getMinanzinfot()
		+ "  " + wp.getMehrbesetzung()+ "  " + wp.getSchließzeit()+ "  " + wp.getHauptzeitbeginn()+ "  " + wp.getHauptzeitende());
		//wp.setÖffentlichstatus(false);
		...
		System.out.println(std.getÖffnungszeit() + "  " + std.getMinanzinfot()
		+ "  " + std.getMehrbesetzung()+ "  " + std.getSchließzeit()+ "  " + std.getHauptzeitbeginn());
		int mhrb=10;
